...
import javafx.scene.layout.StackPane; //stack is a tool used to put stuff on top of each other
...
//          each subgrid is supposed to be sized 80*80 units
        ...
        randno = new Label("0");
        randno.setTranslateX(300);
        randno.setTranslateY(725);

        Image imgbg = new Image("D:\\Java\\SnakesLadders\\src\\main\\resources\\icons\\Pink Snakes - Small.jpg");
 ...
 private void moveplayer1(){
        for(int i = 0; i < rand ; i++){
            ...
            if(p1posX<35 || p1posY<35){ p1posY=35; p1posX=35; randno.setText("aman wonnn !!"); gB.setText("Start Again !"); }
    ...
    private void moveplayer2(){
        for(int i = 0; i < rand ; i++){
            ...
            if(p2posX<35 || p2posY<35){ p2posY=35; p2posX=35; randno.setText("raghav wonnn !!"); gB.setText("Start Again !"); }
